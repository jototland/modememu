# This is stolen from http://timgolden.me.uk/python/active_directory.html
# version 0.6.7 from 23th march 2007

# I haved modified it to compile with python 3.10 as of 24 may 2002,
# but not tested beyond that
...
try:
    basestring       # python 2: no changes needed
except NameError:
    basestring = str # python 3: basestring does not exist, use str
